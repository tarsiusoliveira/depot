...
#   Character.create(name: 'Luke', movie: movies.first)
  Product.create!(
    ...
    image_url: 'https://thumbs.dreamstime.com/b/cup-coffee-coffee-beans-isolated-white-background-copy-space-text-coffee-cup-beans-isolated-white-background-164317823.jpg',
    price: 20.00)
